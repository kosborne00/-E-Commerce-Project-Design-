...
-- Inventory is 1-to-1 with Product; separated to isolate volatile writes
...
-- SAMPLE DATA
-- Disclaimer: Sample data was created with the help of AI.
...
INSERT INTO `Order` (CustomerID, ShippingAddressID, OrderDate, Status, TotalAmount, PaymentMethod) VALUES
  (1, 1, '2024-01-10 14:22:00', 'Delivered',  1049.98, 'Credit Card'),  -- O1: phone+earbuds
  (2, 2, '2024-01-18 09:05:00', 'Delivered',   189.99, 'PayPal'),        -- O2: knife set
  (3, 3, '2024-02-03 16:40:00', 'Delivered',  1299.99, 'Credit Card'),   -- O3: laptop
  (1, 1, '2024-02-14 11:00:00', 'Delivered',   149.99, 'Credit Card'),   -- O4: headphones
  (4, 5, '2024-03-07 13:30:00', 'Delivered',   129.99, 'Debit Card'),    -- O5: Instant Pot
  (3, 4, '2024-03-22 10:15:00', 'Delivered',   219.98, 'Credit Card'),   -- O6: shirt+chino
  (2, 2, '2024-04-05 08:50:00', 'Delivered',    89.99, 'PayPal'),        -- O7: linen dress
  (1, 1, '2024-04-19 17:00:00', 'Delivered',   899.99, 'Credit Card'),   -- O8: ProPhone 15
  (3, 3, '2024-05-01 12:20:00', 'Delivered',   259.97, 'Credit Card'),   -- O9: sweater+earbuds+tool
  (4, 5, '2024-05-14 09:00:00', 'Delivered',    49.99, 'Debit Card'),    -- O10: garden kit
  (2, 2, '2024-06-02 14:10:00', 'Delivered',   149.99, 'PayPal'),        -- O11: headphones
  (1, 1, '2024-06-20 11:45:00', 'Delivered',   129.99, 'Credit Card'),   -- O12: cashmere sweater
  (3, 3, '2024-07-08 10:30:00', 'Delivered',  1299.99, 'Credit Card'),   -- O13: laptop (gift)
  (5, 6, '2024-01-25 15:00:00', 'Delivered',   189.98, 'Credit Card'),   -- O14: shirt+chino  <-- last order for Eve
  (2, 2, '2024-07-30 12:00:00', 'Delivered',   399.98, 'PayPal'),        -- O15: knife+tool
  (4, 5, '2024-02-28 10:00:00', 'Delivered',    79.99, 'Debit Card'),    -- O16: earbuds  <-- last for Dave
  (1, 1, '2024-08-15 09:30:00', 'Shipped',     129.99, 'Credit Card'),   -- O17: Instant Pot
  (3, 3, '2024-08-22 14:00:00', 'Pending',      59.99, 'Credit Card');   -- O18: oxford shirt
...
INSERT INTO Review (CustomerID, ProductID, Rating, Comment, ReviewDate) VALUES
  (1, 1,  5, 'Best phone I''ve ever owned. Fast and great camera.',   '2024-01-20'),
  (1, 5,  4, 'Good earbuds for the price, comfortable fit.',          '2024-01-20'),
  (2, 10, 5, 'Knives are incredibly sharp. Worth every penny.',       '2024-01-25'),
  (3, 2,  5, 'Blazing fast laptop. Battery life is impressive.',      '2024-02-15'),
  (1, 3,  4, 'Great noise cancellation. Comfortable for long use.',   '2024-02-22'),
  (4, 11, 5, 'Cooks everything perfectly. Easy to clean.',            '2024-03-15'),
  (3, 6,  4, 'Well-made shirt. Fits true to size.',                   '2024-03-30'),
  (3, 8,  3, 'Decent chinos but the color faded after one wash.',     '2024-03-30'),
  (2, 7,  5, 'Beautiful dress! Great quality linen.',                 '2024-04-12'),
  (3, 9,  5, 'Incredibly soft cashmere. Worth the price.',            '2024-05-10'),
  (2, 3,  5, 'Amazing headphones. Best purchase this year.',          '2024-06-10'),
  (1, 9,  4, 'Very cozy sweater. Sizing runs slightly large.',        '2024-06-28'),
  (4, 12, 4, 'Solid garden tools. Good quality for the price.',       '2024-05-20');
